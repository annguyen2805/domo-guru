...
try {
    ...
    WebUI.verifyElementPresent(findTestObject('Object Repository/EditCustomerPageUI/NotificationMessage'), 5)

    println('Edit successfully')
}
CustomKeywords.'common.updateCustomerInfo'(customerID)