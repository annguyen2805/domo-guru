...
WebUI.callTestCase(findTestCase('Test Steps/Customer Pages/Create Customer'), [('name') : name, ('gender') : gender, ('dOB') : dOB, ('address') : address
        , ('city') : city, ('state') : state, ('pin') : pin, ('phone') : phone, ('mail') : mail, ('pass') : pass], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Steps/Customer Pages/Verify Create Customer Successfully'), [('name') : name, ('gender') : gender
