...
'create a customer'
String customerID = WebUI.callTestCase(findTestCase('Test Farm/New Customer Page/Create Customer Successfully'), [('name') : name
...
List account1 = WebUI.callTestCase(findTestCase('Test Farm/New Account/Create Account Successfully'), [('customerID') : customerID
        , ('accountType') : accountType, ('iniDeposit') : iniDeposit], FailureHandling.STOP_ON_FAILURE)

List account2 = WebUI.callTestCase(findTestCase('Test Farm/New Account/Create Account Successfully'), [('customerID') : customerID
        , ('accountType') : accountType, ('iniDeposit') : iniDeposit], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Farm/Balane Enquiry Page/Verify Balance'), [('accountID') : payerAccount, ('expectedBalance') : expectedBalance], 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Farm/Delete Account/Delete Account Sucessfully'), [('accountID') : payerAccount], FailureHandling.STOP_ON_FAILURE)

'Delete Payee Account'
WebUI.callTestCase(findTestCase('Test Farm/Delete Account/Delete Account Sucessfully'), [('accountID') : payeeAccount], FailureHandling.STOP_ON_FAILURE)

'Delete Customer'
WebUI.callTestCase(findTestCase('Test Farm/Delete Customer/Delete Customer Sucessfully'), [('customerID') : customerID], FailureHandling.STOP_ON_FAILURE)
