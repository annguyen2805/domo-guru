...
String currentBalance = idAndBalance[1]

WebUI.callTestCase(findTestCase('Test Farm/Balane Enquiry Page/Verify Balance'), [('accountID') : accountID, ('expectedBalance') : currentBalance], 
